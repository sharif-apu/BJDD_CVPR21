...
class DPBS:
    def __init__(self, config):
        ...
        self.checkpointPath = "/media/sharif-apu/XtrasHD1/PixelBinnedModelLog/QuadBayerJDD_checkpoints/checkpoint_AUNET/"#config['checkpointPath']
        self.logPath = "/media/sharif-apu/XtrasHD1/PixelBinnedModelLog/TensorboardLog/logDir_AUNET/"#config['logPath']
